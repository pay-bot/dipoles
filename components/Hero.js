  ...
  return (
    <div className="bg-hero h-[650px]">
      ...
      <div className="text-center">
        <button className="md:mt-2 lg:mb-16 my-16 uppercase bg-blue-500 px-4 py-2 text-3xl font-semibold tracking-wider text-white rounded hover:bg-blue-600">order now!</button>
