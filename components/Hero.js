  ...
  return (
    <div className="bg-hero h-[650px]">
      ...
      <div className="text-center md:mt-32 lg:mb-5 md:mb-10 mt-36">
        <h1 className="xl:w-7/12 lg:w-8/12 md:w-9/12 w-10/12 mx-auto my-10 lg:text-5xl md:text-4xl text-2xl text-white font-semibold">Jasa Poles Marmer Professional Terbaik di Jabodetabek.</h1>
